...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private boolean requestPermissions() {
        ...
        int requestCode = 200;
        String[] permission = {"android.permission.READ_CONTACTS","android.permission.INTERNET"};
        ...
        if (checkCallingOrSelfPermission(permission[0]) == PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(LoginActivity.this, permission, requestCode);
        }
        return false;
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        switch (requestCode) {
            case 200:
                boolean contactsRead = grantResults[0] == PackageManager.PERMISSION_GRANTED;
                boolean internet = grantResults[1] == PackageManager.PERMISSION_GRANTED;

                if (contactsRead && internet) {
                    populateAutoComplete();
                }
                break;
        }
